...
{
    public sealed class LogitechLcdx86 : ILogitechLcd
    {
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdInit", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdIsConnected", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdIsButtonPressed", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdUpdate", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdShutdown", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdMonoSetBackground", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdMonoSetText", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdColorSetBackground", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdColorSetTitle", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        ...
        [DllImport("LogitechLcd.x86.dll", EntryPoint = "LogiLcdColorSetText", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
